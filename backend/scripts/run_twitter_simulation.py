...
Verwendung:
    ...
    python run_twitter_simulation.py --config /path/to/simulation_config.json --no-wait  # nach Abschluss sofort beenden
"""
...
class TwitterSimulationRunner:
    """Twitter-Simulations-Runner"""
    
    # Twitter verfügbare Aktionen (ohne INTERVIEW，INTERVIEW nur via ManualAction auslösbar）
    AVAILABLE_ACTIONS = [
    ...
    def _get_profile_path(self) -> str:
        """Profildatei-Pfad (OASIS Twitter nutzt CSV)"""
    ...
    def _get_active_agents_for_round(
        ...
        # Aktivierungswahrscheinlichkeit pro Agent berechnen
        candidates = []
        for cfg in agent_configs:
            ...
            # Wahrscheinlichkeit nach Aktivitätsgrad
